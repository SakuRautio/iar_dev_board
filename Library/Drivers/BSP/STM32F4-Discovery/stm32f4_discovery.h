/** 
  ...
  * @brief   Definitions for the Arm side of the IAR DevCon board
  *          LEDs and push-button hardware resources.
  ******************************************************************************
  * @attention
  *
  ******************************************************************************  
...
#define LEDx_GPIO_CLK_ENABLE(__INDEX__) do{if((__INDEX__) == 0) LED1_GPIO_CLK_ENABLE(); else \
                                           ...
                                           if((__INDEX__) == 4) LED5_GPIO_CLK_ENABLE(); \
                                           }while(0)
...
#define LEDx_GPIO_CLK_DISABLE(__INDEX__) do{if((__INDEX__) == 0) LED1_GPIO_CLK_DISABLE(); else \
                                            ...
                                            if((__INDEX__) == 4) LED5_GPIO_CLK_DISABLE(); \
                                            }while(0)
/**
  * @}
  */ 
